...
const PARTICIPATING_COUNTIES = [
  { countyfp: "013", name:"Barrow", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "015", name:"Bartow", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "021", name:"Bibb", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "031", name:"Bulloch", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "039", name:"Camden", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "045", name:"Carroll", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "047", name:"Catoosa", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "051", name:"Chatham", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "057", name:"Cherokee", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "059", name:"Clarke", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "063", name:"Clayton", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "067", name:"Cobb", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "073", name:"Columbia", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "077", name:"Coweta", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "089", name:"DeKalb", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "095", name:"Dougherty", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "097", name:"Douglas", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "103", name:"Effingham", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "113", name:"Fayette", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "115", name:"Floyd", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "117", name:"Forsyth", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "121", name:"Fulton", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "127", name:"Glynn", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "129", name:"Gordon", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "135", name:"Gwinnett", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "139", name:"Hall", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "151", name:"Henry", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "153", name:"Houston", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "157", name:"Jackson", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "179", name:"Liberty", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "185", name:"Lowndes", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "215", name:"Muscogee", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "217", name:"Newton", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "223", name:"Paulding", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "245", name:"Richmond", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "247", name:"Rockdale", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "255", name:"Spalding", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "285", name:"Troup", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "295", name:"Walker", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "297", name:"Walton", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
  { countyfp: "313", name:"Whitfield", profile: 'fullmodel', outoforder:"Polling location modeling will be provided for this county soon", datafootnote: "", exceptlayers: [] },
];
...
const getParticipatingCountyInfo = function (countyfp) {
    ...
    if (! returnme.datalayers) throw new Error(`County ${countyfp} has invalid profile ${entry.profile}`);
...
const BOUNDSTYLE_PARTICIPATING = { fillColor: 'blue', weight: 1, opacity: 0.5, color: 'black', fillOpacity: 0.1 };
...
const UNRELIABLE_STYLE = { color: 'black', fillColor: 'black', fillOpacity: 0.8, stroke: false };
